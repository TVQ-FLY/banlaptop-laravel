            ...
            <div class="footer-logo-wrap pt-50 pb-35">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="des">
                            <li>
                                <span>Địa chỉ: </span><a href="{{route('lienhe')}}">525A Điện Biên Phủ, Phường 25 , Q.Bình Thạnh , TP Hồ Chí Minh</a>
                            </li>
                            <li>
                                <span>SĐT: </span>
                                <a href="tel: 0901234567">090.xxx.xnxx (Lê Anh Quang)</a>
                            </li>
                            <li>
                                <span>Email: </span>
                                <a href="mailto: support@shopvitinh.com">Support@shopvitinh.com</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-3">
                        <div class="footer-block">
                            ...
                            <ul>
                                <li><i class="fa fa-phone"></i> Phòng Kinh Doanh: <p class="footer-lienhe">090.xxx.xnxx (Lê Anh Quang)</p>
                                </li>
                                <li><i class="fa fa-phone"></i> Chăm Sóc Khách Hàng: <p class="footer-lienhe">090.xxx.xnxx (Lê Anh Quang)</p>
                                </li>
                                <li><i class="fa fa-phone"></i> Bảo Hành: <p class="footer-lienhe">090.xxx.xnxx (Lê Anh Quang)</p>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="copyright text-center pt-15 pb-20">
                    <span>&copy;2023 Nguyễn Thành Trung & Nguyễn Thanh Lâm</span>
                </div>
